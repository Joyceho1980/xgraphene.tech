# TASK: Upgrade C-Level V2 Article — Why Do I Wake Up Tired?

## Priority: P1
## Context: This is a C-Level Entry Node for the Cellular Energy Hub. It captures users searching "why do I wake up tired" / "waking up with no energy" and establishes concept awareness before routing to deeper A/B-level content.

## Source
Content body: `SEO-GEO/ARTICLE TEMPLATE/CV2 TEMPLATE.txt` (lines 2-105, "The Invisible Energy That Determines Your Day")

## Output
**Replace** existing file: `pages/SCIENCE/KNOWLEDGE/cellular-energy/why-do-i-wake-up-tired.html`
...
### 1. Title
Keep existing title: **"Why Do I Wake Up Tired?"**

### 2. Node Definition (new V2 element — place between Quick Answer and AI Core Summary)
...
### 5. Body (from CV2 TEMPLATE.txt)

**Content from CV2 TEMPLATE.txt lines 2-105 (from "Have you ever had a morning like this—" to the end of the body).**
...
The body begins: "The alarm goes off. You wake up. Your eyes are open, but your body feels like it's being pressed down by something heavy..."
The body ends: "Next, we'll look at the factory itself—how mitochondria actually work."

### 6. Knowledge Position (new V2 element — place after body, before FAQ)
...
Must include schema.org FAQPage JSON-LD in `<head>`. Questions:
...
### 8. Knowledge Navigation (C-level version — NO upstream)
...
```json
{
  ...
  "@type": "Article",
  "headline": "Why Do I Wake Up Tired?",
...
Also add FAQPage schema for the 3-4 FAQ questions.

### 11. Images

1 image only (Hero emotional illustration). User will provide the filename. Use placeholder for now:

```
Hero background: /ASSETS/GEOGRAPHIC/PICTURE/empty-double-hero.jpg
```

### 12. Styling

- Keep existing CSS from the current file as much as possible
- Add new CSS classes: `.quick-answer`, `.ai-core-summary`, `.node-definition`, `.knowledge-position`, `.kg-navigation`, `.disclaimer`
- Follow the same Navy/Gold/Slate color system
- Max content width: 1100px (centered)

## Verification Checklist

- [ ] Page loads at `/SCIENCE/KNOWLEDGE/cellular-energy/why-do-i-wake-up-tired.html`
- [ ] Title changed to "Why Do I Wake Up With No Energy? The Invisible Force That Decides Your Day"
...
- [ ] FAQ has 3-4 questions with valid FAQPage schema
- [ ] Knowledge Navigation — NO upstream, only "Continue Exploring" links
- [ ] Scientific Disclaimer present
- [ ] Article Schema + FAQPage Schema in `<head>`
- [ ] All links use relative paths
- [ ] No product mention in body
