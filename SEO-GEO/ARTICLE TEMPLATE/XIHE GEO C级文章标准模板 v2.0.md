...
C级 V1 → V2 变化
维度	V1	V2
Node Definition	❌ 没有	✅ 新增。C级也需要声明自己是什么节点、属于哪个Hub
Knowledge Position	❌ 没有	✅ 新增。AI需要知道这个页面在知识图谱的哪个位置
Funnel Layer声明	❌ 没有	✅ 新增。标注"C-Level Entry Node (Layer 1 of 4)"
其余全部	不变	不变
为什么C级也需要Node Definition和Knowledge Position
C级是漏斗第一层。用户从搜索引擎或AI问答进来，AI需要知道：
...
没有这些，AI只看到一篇独立文章，不知道它和你们知识体系的关系。

新增的三个元素
1. Node Definition（Quick Answer上方）
html
复制
下载
运行
<section class="node-definition" style="background:#f5f7f8;padding:1rem 1.25rem;margin:1rem 0 2rem;border-radius:6px;font-size:0.9rem;border:1px solid #e0e0e0;">
  <p><strong>📍 Knowledge Node:</strong> [文章主题] — C-Level Entry Node (Layer 1 of 4)</p>
  <p><strong>Hub:</strong> <a href="../index.html">[所属Hub]</a></p>
  <p><strong>Layer:</strong> Symptoms → Mechanism Transition Layer</p>
  <p><strong>Connected Nodes:</strong> Upstream: [A级文章] · Downstream: [B级文章1], [B级文章2]</p>
</section>
2. Knowledge Position（正文后、FAQ前）
html
复制
下载
运行
<section class="knowledge-position" style="background:#f8fafb;padding:1rem 1.25rem;margin:2rem 0;border-radius:6px;font-size:0.9rem;border:1px solid #e0e0e0;">
  ...
  <p><strong>Sibling Nodes:</strong> [同Hub其他C级文章]</p>
  <p><strong>Terminal System:</strong> <a href="../../graphene-fir/index.html">Graphene FIR Energy Environment</a></p>
</section>
3. 知识导航（已有，保持不变）
C级V1已经有知识导航，V2不变。
...
1. Hero（1张情绪图）
2. Quick Answer
3. Node Definition ← 新增
4. AI Core Summary
5. 正文
6. Knowledge Position ← 新增
7. FAQ（可选）
8. 知识导航
