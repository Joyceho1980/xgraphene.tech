...
SKIP_DIRS = {"node_modules", ".git", ".vercel", "admin", "VISUAL-LIBRARY", "PICTURE", "DOCUMENTS", "output", "images", "images-root", "SEO-GEO", "science", "DRAFTS", "ASSETS", "AGENT-COMMS", ".agents", ".codex", ".trae"}
